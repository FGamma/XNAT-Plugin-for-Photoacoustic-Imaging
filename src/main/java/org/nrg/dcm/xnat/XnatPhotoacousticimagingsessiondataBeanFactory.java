...
import org.nrg.xdat.bean.XnatPhotoacousticimagingsessiondataBean;

/**
 *
 * @author jamesd
 * modified by Choon (SDIPR) for Photoacousticimaging
 */
@Component
public class XnatPhotoacousticimagingsessiondataBeanFactory
        extends XnatImagesessiondataBeanFactory
{
                                           ...
                                           String studyInstanceUid, Map<String, String> parameters)
    {
        ...
        {
            return new XnatPhotoacousticimagingsessiondataBean();
        }
        return null;
    }
