/*
 * dicom-xnat-mx: org.nrg.dcm.xnat.OPScanAttributes
...
/**
 * opScanData attributes
 * @author Kevin A. Archie &lt;karchie@wustl.edu&gt;
 * modified by Choon (SDIRP) for PHOTOACOUSTICIMAGING
 */
class PHOTOACOUSTICIMAGINGScanAttributes {
    private PHOTOACOUSTICIMAGINGScanAttributes() {} // no instantiation
